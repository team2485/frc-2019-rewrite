...
public class RobotContainer {
    ...
    public void configureCommands() {
        ...
        jack.getJoystickButton(Button.kBumperLeft)
...
//        }));
         ...
         */
        //Cargo intake
        suraj.getJoystickButton(Button.kBumperLeft)
...
//                                                        new ConditionalCommand(new InstantCommand(()->cargoRollers.setRollersManual(0.2)), null, cargoRollers::isSpiking))
        ...
        //cargo outake
        suraj.getJoystickAxisButton(WL_XboxController.Joystick.kTriggerRight, 0.2)
                .whenActive(new InstantCommand(() -> cargoRollers.setRollersManual(-0.4)));

        suraj.getJoystickAxisButton(WL_XboxController.Joystick.kTriggerLeft, 0.2)
